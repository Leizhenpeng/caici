...
const result = {
  ...
  title: '兰亭集序',
  collectionsCount: 11,
  authorDescTr: '王羲之，東晉書法家，字逸少，號澹齋，漢族，原籍山東琅琊（今山東臨沂），後遷居會稽（紹興），寫下《蘭亭集序》，晚年隱居會稽下轄剡縣金庭，中國東晉書法家，有書聖之稱。歷任祕書郞、寧遠將軍、江州刺史。後爲會稽內史，領右將軍，人稱“王右軍”、“王會稽”。其子王獻之書法亦佳，世人合稱爲“二王”。此後歷代王氏家族書法人才輩出。東晉升平五年卒，葬於金庭瀑布山（又稱紫藤山），其五世孫衡舍宅爲金庭觀，遺址猶存。',
  postsCount: 394,
  author: {
    __type: 'Pointer',
    className: 'Author',
    objectId: '57b8fc225bbb50005b7801ea',
  },
  likesCount: 32370,
  listsCount: 3583,
  kind: 'wen',
  ...
  createdAt: '2016-08-21T00:56:48.248Z',
  updatedAt: '2022-09-02T12:02:44.436Z',
  __type: 'Object',
  className: 'Work',
}
const test2 = {
    ...
    <div bg-base p2 flex="~ center col" text-base mt-2>
      <n-tabs type="bar" animated justify-content="center" w-364px pane-class="pane-style">
        ...
        <n-tab-pane name="translation" tab="白话">
          <card-tab :content="nowCardMeta?.translation" />
        </n-tab-pane>
